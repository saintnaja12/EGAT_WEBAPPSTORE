...
<body>
    ...
    <div class="text-body mt-4">
        ...
        <p style="color: aliceblue; text-align: center;">AndroidOS Applications </p>
    </div>
    ...
    <div class="container" style="text-align: center;">
        ...
        <div class="row" id="nameApp">
            ...
            $query = "SELECT * FROM app_s WHERE system = 'Android' OR system = 'iOS,Android'";
